<%-- 
    Document   : pharmacistLogin
    Created on : Apr 20, 2020, 10:01:17 PM
    Author     : Danac
--%>
...
<head>
  <title>Pharmacist &mdash; LogIn</title>
  <meta charset="utf-8">
...
<body>
    <form action="pharmacistLoginServlet" method="POST">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Pharmacist Login</strong>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="bg-light rounded p-3">
              <p class="mb-0">Hello Pharmacist<a href="#" class="d-inline-block">!!</a> </p>
            </div>
          </div>
        </div>
