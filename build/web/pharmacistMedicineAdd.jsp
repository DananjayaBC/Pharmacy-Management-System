<%-- 
    Document   : pharmacistMedicineAdd
    Created on : Apr 20, 2020, 10:33:14 PM
    Author     : Danac
--%>
...
<head>
  <title>Pharmacist &mdash; Medicine Add</title>
  <meta charset="utf-8">
...
<body>
    ...
    <form action="adminMedicineAddServlet" method="POST">
             <%
       if(session.getAttribute("uName")==null)
       {
          response.sendRedirect("pharmacistLogin.jsp");
       }
            ...
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li class="has-children">
                  <a href="#">MEDICINE</a>
                  <ul class="dropdown">
                    <li><a href="pharmacistMedicineAdd.jsp">ADD MEDICINE</a></li>
                    <li><a href="pharmacistHome.jsp">VIEW LIST</a></li>
                   </ul>
                </li>
               <li class="has-children">
                  <a href="#">Purchased</a>
                  <ul class="dropdown">
                    <li><a href="PharmacistPurchasedView.jsp">UPLOADED</a></li>
                    <li><a href="customerPurchasedView.jsp">BOOKED</a></li>
                   </ul>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <a href="pharmacistHome.jsp">Pharmacist Home</a> <span class="mx-2 mb-0">/</span>
        ...
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="bg-light rounded p-3">
              <p class="mb-0"> <a href="#" class="d-inline-block">Medicine </a></p>
            </div>
          </div>
        </div>
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <input type="text"class="form-control" name="price" value="" required onkeypress="javascript:return isNumber(event)"/>
                </div>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <input type="text"class="form-control" name="quantity" value="" required onkeypress="javascript:return isNumber(event)"/>
                </div>
              </div>
                <div class="form-group row">
                <div class="col-md-12">
                  <label for="c_address" class="text-black">Description <span class="text-danger">*</span></label>
                  <input type="text"class="form-control" name="description" value="" 7023.6/>
                </div>
              </div>
