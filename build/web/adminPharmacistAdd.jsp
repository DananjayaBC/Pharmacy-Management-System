<%-- 
    Document   : adminPharmacistAdd
    Created on : Apr 18, 2020, 11:23:30 AM
    Author     : Danac
--%>
...
<head>
  <title>Admin &mdash; Add Pharmacist</title>
  <meta charset="utf-8">
...
<body>
    ...
    <form action="adminPharmacistAddServlet" method="POST">
            ...
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li class="has-children">
                  <a href="#">MEDICINE</a>
                  <ul class="dropdown">
                    <li><a href="adminMedicineAdd.jsp">ADD MEDICINE</a></li>
                    <li><a href="adminMedicineView.jsp">VIEW LIST</a></li>
                   </ul>
                </li>
                <li class="has-children">
                  <a href="#">PHARMACIST</a>
                  <ul class="dropdown">
                    <li><a href="adminPharmacistAdd.jsp">ADD PHARMACIST</a></li>
                    <li><a href="adminPharmacistView.jsp">VIEW LIST</a></li>
                   </ul>
                </li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <a href="adminHome.jsp">Admin Home</a> <span class="mx-2 mb-0">/</span>
            <strong class="text-black">Add Pharmacist</strong>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="bg-light rounded p-3">
              <p class="mb-0">New <a href="#" class="d-inline-block"> Pharamacist</a></p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            <h2 class="h3 mb-3 text-black">Enter Details</h2>
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  ...
                  <input type="text"class="form-control" name="id" value="" placeholder="ID Number" required  onkeypress="javascript:return isNumber(event)"/>
                </div>
                <div class="col-md-6">
              ...
              <div class="form-group row mb-5">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text"class="form-control" name="phone" value="" placeholder="Phone Number" required  onkeypress="javascript:return isNumber(event)"/>
                </div>
              </div>
                ...
                <textarea name="notes" rows="5" cols="30" class="form-control"  placeholder="Write your notes here" required>
