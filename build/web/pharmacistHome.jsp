<%-- 
    Document   : pharmacistHome
    Created on : Apr 20, 2020, 9:47:50 PM
    Author     : Danac
--%>
...
<head>
  <title>Pharmacist &mdash; Home</title>
  <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Pharmacist Home</strong>
          </div>
        </div>
      </div>
    </div>
                    ...
                    <table border="1" id="t01">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input class="btn btn-info" type="button" onclick="window.location.href = 'adminMedicineUpdate.jsp?no=<%=no%>';" value="EDIT"/></td>
                                <td><input class="btn btn-danger" type="button" onclick="window.location.href = 'adminMedicineDelete.jsp?no=<%=no%>';" value="DELETE"/></td>
                            </tr>
                            <%
                            }
                            %>
