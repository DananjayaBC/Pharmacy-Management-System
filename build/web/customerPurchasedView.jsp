<%-- 
    Document   : customerPurchasedView
    Created on : Apr 27, 2020, 8:48:39 AM
    Author     : Danac
--%>
...
<head>
  <title>Pharmacist &mdash; Booked View</title>
  <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">PURCHASED</strong>
          </div>
        </div>
      </div>
    </div>
                ...
                <div class="col-sm-8">
                    ...
                    <table border="1" id="t01">
                        ...
                        <%
                           ...
                           String query="select * from customerbook";
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><%=rs.getString("postelCode") %></td>
                                <td><%=rs.getString("phone") %></td>
                                
                                <td><input class="btn btn-info" type="button" onclick="window.location.href = 'customerPurchasedView2.jsp?no=<%=no%>';" value="VIEW"/></td>
                                <td><input class="btn btn-danger" type="button" onclick="window.location.href = 'customerPurchasedDelete.jsp?no=<%=no%>';" value="DELETE"/></td>
