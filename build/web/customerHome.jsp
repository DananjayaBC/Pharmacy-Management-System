<%-- 
    ...
    Created on : Apr 18, 2020, 9:32:36 AM
    Author     : Danac
--%>
...
<body>
    <form action="medicineAdd" method="POST" enctype="multipart/form-data">
            <%
            ...
            <div class="bg-light rounded p-3">
              <p class="mb-0">Book <a href="#" class="d-inline-block">MEDICINE</a></p>
               ...
               <div class="form-group row">
                <div class="col-md-3">
                   <div class="row">
                  <h2 class="h3 mb-3 text-black">Upload Prescription</h2>
                  <input type="file" class="form-control"value=""  name="photo" value="" required="required" />
                </div>
              </div>
               </div>
            ...
            <div class="p-3 p-lg-5 border">
             <div class="form-group row">
                <div class="col-md-6">
                  ...
                  <input type="text"class="form-control" value=""  name="fName" value="" required/>
                </div>
                <div class="col-md-6">
                  <label for="c_lname" class="text-black">Last Name <span class="text-danger">*</span></label>
                  <input type="text"class="form-control" value=""  name="lName" value="" required/>
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control"value=""  name="email" value="" required/>
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <input type="text"class="form-control"value=""  name="address" value="" required/>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text"class="form-control" name="postelCode" value="" onkeypress="javascript:return isNumber(event)" required/>
                </div>
              </div>
              ...
              <div class="form-group row mb-5">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text"class="form-control" name="phone" value="${phone}" placeholder="Phone Number" onkeypress="javascript:return isNumber(event)" required/>
                </div>
              </div>
