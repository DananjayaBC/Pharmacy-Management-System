...
<head>
  <title>Customer &mdash; Sign Up</title>
  <meta charset="utf-8">
              ...
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                <li class="active"><a href="index.jsp">Home</a></li>
                  ...
                  <ul class="dropdown">
                    ...
                    <li><a href="logIn2.jsp">BOOK MEDICINE</a></li>
        ...
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="bg-light rounded p-3">
              <p class="mb-0">Allready SignUp!! <a href="logIn.jsp" class="d-inline-block">Click here</a> to login</p>
            </div>
          </div>
        </div>
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <input type="text"class="form-control" name="address" value="" placeholder="Delivery Address"/>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text"class="form-control" name="postelCode" value="" />
                </div>
              </div>
              ...
              <div class="form-group row mb-5">
                ...
                <textarea name="notes" rows="5" cols="30" class="form-control"  placeholder="Write your notes here...">
                </textarea>
              </div>
                 <div class="form-group">
