<%-- 
    Document   : adminHome
    Created on : Apr 17, 2020, 10:30:19 AM
    Author     : Danac
--%>
...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url('images/hero_2.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              ...
              <h1>Welcome Admin</h1>
              <p>
                <a href="https://covid19.gov.lk/" class="btn btn-primary px-5 py-3">COVID-19 UPDATES</a>
              </p>
            </div>
          </div>
        </div>
