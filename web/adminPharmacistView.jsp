...
<head>
  <title>Admin &mdash; Pharamacist Details</title>
  <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">View Pharmacist</strong>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="bg-light rounded p-3">
              <p class="mb-0">Pharamacist <a href="#" class="d-inline-block"> List</a></p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            <h2 class="h3 mb-3 text-black">Pharamacist Details</h2>
                    ...
                    <table border="1" id="t01">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input class="btn btn-info" type="button" onclick="window.location.href = 'adminPharmacistUpdate.jsp?no=<%=no%>';" value="EDIT"/></td>
                                <td><input class="btn btn-danger" type="button" onclick="window.location.href = 'adminPharmacistDelete.jsp?no=<%=no%>';" value="DELETE"/></td>
                            </tr>
                            <%
                            }
                            %>
