<%-- 
    Document   : adminMedicineAdd
    Created on : Apr 19, 2020, 10:34:06 PM
    Author     : Danac
--%>
...
<head>
  <title>Admin &mdash; Medicine Add</title>
  <meta charset="utf-8">
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <input type="text"class="form-control" name="price" value="" onkeypress="javascript:return isNumber(event)" required/>
                </div>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <input type="text"class="form-control" name="quantity" value="" onkeypress="javascript:return isNumber(event)" required/>
                </div>
              </div>
                <div class="form-group row">
                <div class="col-md-12">
