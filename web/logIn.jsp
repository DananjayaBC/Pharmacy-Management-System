...
<head>
  <title>Customer &mdash; LogIn</title>
  <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="bg-light rounded p-3">
              <p class="mb-0">Not Registered !! <a href="SignUP.jsp" class="d-inline-block">Click here</a> to SignUp</p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            <h2 class="h3 mb-3 text-black">Enter LogIn Details</h2>
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <label for="c_companyname" class="text-black">User Name <span class="text-danger">*</span> </label>
