            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  ...
                  <input type="text"class="form-control" value="<%=rs.getString("name")%>"  name="name" value="" readonly/>
                </div>
                <div class="col-md-6">
                  <label for="c_lname" class="text-black">Category <span class="text-danger">*</span></label>
                  <input type="text"class="form-control" value="<%=rs.getString("category")%>"  name="category" value="" readonly/>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6 mb-5 mb-md-0">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text"class="form-control" value="<%=rs.getString("postelCode")%>"  name="name" value="" readonly/>
                </div>
                <div class="col-md-6">
                ...
                <br>
                 ...
                 <div class="form-group">
                     ...
                     <input class="btn btn-black" type="button" onclick="window.location.href = 'customerPurchasedView.jsp';" value="BACK"/>
