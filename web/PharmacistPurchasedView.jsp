<%-- 
    Document   : PharmacistPurchasedView
    Created on : Apr 23, 2020, 3:10:59 PM
    Author     : Danac
--%>
...
<head>
  <title>Pharmacist &mdash; Purchased View</title>
  <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">Purchased View</strong>
          </div>
        </div>
      </div>
    </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><%=rs.getString("province") %></td>
                                 <td><input class="btn btn-info" type="button" onclick="window.location.href = 'pharmacistPurchasedView2.jsp?no=<%=no%>';" value="VIEW"/></td>
                                 <td><input class="btn btn-danger" type="button" onclick="window.location.href = 'PharmacistPurchasedDelete.jsp?no=<%=no%>';" value="DELETE"/></td>
